# https://github.com/nmichlo/disent/blob/main/disent/metrics/_unsupervised.py
...
def metric_unsupervised(
    ...
    mus_train, _ = disent_utils.generate_batch_factor_code(ground_truth_data, representation_function, num_train, batch_size)
    ...
    mus_discrete = disent_utils.histogram_discretize(mus_train, num_bins=20)
    mutual_info_matrix = disent_utils.discrete_mutual_info(mus_discrete, mus_discrete)
