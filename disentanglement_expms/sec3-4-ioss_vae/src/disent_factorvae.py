# https://github.com/nmichlo/disent/blob/main/disent/metrics/_factor_vae.py
# coding=utf-8
...
def _compute_variances(
    ...
    representations = to_numpy(disent_utils.obtain_representation(observations, representation_function, eval_batch_size))
