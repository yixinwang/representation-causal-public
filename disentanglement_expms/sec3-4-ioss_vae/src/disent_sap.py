# https://github.com/nmichlo/disent/blob/main/disent/metrics/_sap.py
...
def metric_sap(
    ...
    mus, ys = disent_utils.generate_batch_factor_code(ground_truth_data, representation_function, num_train, batch_size)
    mus_test, ys_test = disent_utils.generate_batch_factor_code(ground_truth_data, representation_function, num_test, batch_size)
