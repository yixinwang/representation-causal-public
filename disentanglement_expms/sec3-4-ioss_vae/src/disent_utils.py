# code from https://github.com/nmichlo/disent/blob/main/disent/metrics/utils.py
...
# from disent.dataset import GroundTruthData
...
def generate_batch_factor_code(
        ground_truth_dataset: GroundTruthData,
